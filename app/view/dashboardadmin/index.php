        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active mb-0">
                <a class="nav-link" href="index.html">
                    ...
                    <span>Dashboard SuperAdmin</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="min-height: 550px;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Kelola User (SuperAdmin)</h1>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="min-height: 270px !important;">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?=BASEURL?>/dashboardadmin/addNewUser" method="POST" class="form-control" style="border:none !important;">
                                            <div class="row">
